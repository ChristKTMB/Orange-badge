...
<div class="row">
   <div class="col-lg-12 margin-tb">
                        ...
                        <form action="{{ route('approving.store') }}" method="POST">
                           ...
                           <table class="table table-bordered" id="dynamicAddRemove">
                              ...
                              <tr>
                                 ...
                                 <td><input type="text" name="data[0][function]"  placeholder="Enter function" class="form-control" />
                                 </td>
                                 <td><input type="email" name="data[0][email]" placeholder="Enter email" class="form-control" />
                                 </td>
                                 <td><button type="button" name="add" id="dynamic-ar" class="btn btn-outline-primary"><i class="fas fa-solid fa-plus"></i></button></td>
                              </tr>
                           </table>
      ...
      @else
      <div class="text-right mx-4 mb-3">
         <a class="btn btn-outline-danger" href="{{ route('approving.confirmDelete') }}"><i class="fas fa-trash"></i></a>
      </div>
      @endif
   </div>
</div>
